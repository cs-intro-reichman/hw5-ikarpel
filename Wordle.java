...
public class Wordle {
    ...
    public static String[] readDictionary(String filename) {
        // תבדוק איך אתה יודע מה הגדול של המערך
		In in = new In(filename);
        String full = in.readAll();
        String[] dic = full.split("\\s+");
        return dic;
    ...
    public static boolean containsChar(String secret, char c) {
        //לשים לב שנקודה מסוכנת כי אם יש פעמים את התו
